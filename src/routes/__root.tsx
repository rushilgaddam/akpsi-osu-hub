...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Mu Chapter of Alpha Kappa Psi at The Ohio State University — premier co-ed business fraternity built on brotherhood, professionalism, and service." },
      { name: "author", content: "AKPsi Mu Chapter" },
