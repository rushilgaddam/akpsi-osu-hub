...
export function Footer() {
  return (
    <footer className="relative mt-32 border-t border-border/60 bg-foreground text-background">
            ...
            <div className="flex gap-2">
              {[
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="w-10 h-10 rounded-full border border-background/15 flex items-center justify-center hover:bg-primary hover:border-primary transition-all"
                >
                  <Icon size={16} />
                </a>
              ))}
            </div>
            <p className="mt-6 text-sm text-background/60">akpsi.osu@gmail.com</p>
          </div>
        </div>

        <div className="mt-16 pt-6 border-t border-background/10 flex flex-col md:flex-row justify-between gap-2 text-xs text-background/50">
